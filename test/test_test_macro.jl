...
using BaseTestAuto: parse_test_macro_args, Pass
...
@testset "no assertion expr, two options" begin
...
@testset "assertion type, one option" begin
...
@testset "do_test" begin

@testset "passing true predicate assertion" begin
#    ta = PredicateTrueAssertion()
#    res = Returned(:(a), 1)
#    @show get_testset()
#    o = do_test(ta, res, :(a))
#    @test isa(o, Pass)
#    @test o.testassertion == ta
end
