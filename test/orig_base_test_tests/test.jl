# This is the orig Base.Test tests from Julia git repo but modified to use
# BaseTestAuto instead of BaseTest.
...
@test typeof(ts.results[1]) == Test.Pass
...
@test typeof(tss[1].results[1]) == Test.Pass


DTS = Test.DefaultTestSet   # So we need not import it...
global global_var = 0
nonglobal_var = 0
